...
@WithTag("UI")
public class GrapeRipenessFailTest extends UiBaseTest {

    public static final String GRAPE_NAME = "strugureSorin3"; // schimba valoarea pentru a avea un nou tip de strugure
    ...
    public void testGrapeRipeness() {
        ...
        vineyardUiSteps.verifyWineTypeCount(wineCount);
